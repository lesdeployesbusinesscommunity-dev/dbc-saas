...
// tableau.
export function ComparisonTable({ levels, selectedKey, onSelect }) {
              ...
              {levels.map((level) => {
                ...
                return (
                  <RowTag
                    ...
                    className={clsx(
                      "grid grid-cols-[1.5fr_1fr_1fr_1fr_1.3fr] items-center gap-2 rounded-lg border-l-4 px-3 py-3 text-left text-sm transition-colors duration-300",
                      isSelected
                        ? clsx(
                            level.borderClass,
                            level.bgTintClass,
