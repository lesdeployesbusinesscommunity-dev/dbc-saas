      ...
      <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2">
        <div>
          ...
          <Reveal show={isInView} delay={380}>
            {/* "inline-block" : JoinDbcButton rend un <a>, "inline" par
                défaut, sur lequel "mt-6" n'aurait sinon aucun effet (voir
                ContactForm.jsx pour le même correctif). */}
            <JoinDbcButton className="mt-6 inline-block" />
          </Reveal>
        </div>
